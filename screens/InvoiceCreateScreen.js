...
class InvoiceCreateScreen extends Component {
  ...
  static navigationOptions = ({ navigation }) => {
    return {
      ...
      headerLeft: <Icon.Button
        ...
        size={40}
        onPress={_.debounce(() => {
          navigation.goBack(null), 1000, { leading: true, trailing: true };
        })
        }
      />,
    };
  ...
  onSubmit = async () => {
    ...
    const y = Object.assign({}, { ...this.props.invoice }, { coItems: null })
  ...
  calcDueDate() {
    const a = moment(this.props.createdAt);
    a.add(this.props.paymentTerms * 1, 'days');
    const dueDate = a.format(DATE_RFC2822);
